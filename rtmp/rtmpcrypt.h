 ...
 */
int ff_rtmpe_gen_pub_key(RTMPCtx *rt, uint8_t *buf);
 ...
 * @return zero on success, negative value otherwise
 */
int ff_rtmpe_compute_secret_key(RTMPCtx *rt, const uint8_t *serverdata,
 ...
 */
void ff_rtmpe_encrypt_sig(RTMPCtx *rt, uint8_t *signature,
 ...
 * @return zero on success, negative value otherwise
 */
int ff_rtmpe_update_keystream(RTMPCtx *rt);
